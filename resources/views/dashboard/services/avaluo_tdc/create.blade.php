        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header mb-2" style="    display: flex;justify-content: space-between;">
                    <span>Solicitar Servicio de Avaluo de traslado de dominio</span>
                </div>
                <div class="card-body">

                    <form method="POST" action="/dashboard/servicios/avaluo-traslado-de-dominio" enctype="multipart/form-data">
                        @csrf
